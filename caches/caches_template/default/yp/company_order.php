...
<div class="col-auto">
<div class="col-1 ">
<div class="tab-but cu-span"><a href="<?php echo APP_PATH;?>index.php?m=yp&c=business&a=pay&t=3"<?php if(!is_numeric($status)) { ?> class="on"<?php } ?>><span>全部订单</span></a><a href="<?php echo APP_PATH;?>index.php?m=yp&c=business&a=pay&status=1&t=3"<?php if($status==1) { ?> class="on"<?php } ?>><span>已发货订单</span></a><a href="<?php echo APP_PATH;?>index.php?m=yp&c=business&a=pay&status=0&t=3"<?php if($status===0) { ?> class="on"<?php } ?>><span>未发货订单</span></a></div>
<div class="content">
