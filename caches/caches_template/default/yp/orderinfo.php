...
<div class="ver-form">
	...
	<?php $total_fee += $p['price']*$p['quantity']?>
      <tr>
        ...
        <td style="color:#FF0000;font-weight:bold;font-family:verdana;text-align:center;">￥<?php echo $p['price'];?></td>
    ...
    <tfoot>
      <tr>
        <td colspan="6">
			<p>您账户余额：<span style="color:#FF0000;font-weight:bold;font-family:verdana;">￥<?php echo $amounts;?></span><?php if($total_fee>$amounts) { ?>。余额不足，<a href="<?php echo APP_PATH;?>index.php?m=pay&c=deposit&a=pay" style="color:#FF0000;" target="_blank">请充值</a> <input type="button" value="充值完成" onclick="javascript:location.reload();" class="button"><?php } ?></p>
            <p class="f14"><strong>商品总价格：</strong><span class="font-fixh f18">￥<?php echo substr((string)($total_fee+0.001), 0, -1);?> </span></p>
        </td>
      </tr>
  	</tfoot>
</table>
